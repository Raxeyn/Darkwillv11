...
exports.run = async (client, message, args) => {
  ...
  if(samet == null) return message.channel.send('Kayıt Sistemi eklemek için <`s!kayıt-rol @rol`/`s!kayıt-kanal #kanal`/`s!kayıt-log #kanal`> şeklinde Ayarlıya bilirsiniz. ');
